...
//setContentView(Constraint)
     ...
     //   initView()
        ...
        /*new code
        */
         val btnInterstitial = findViewById(com.draco.ludere.R.id.btnInterstitialBanner) as Button
        ...
        btnInterstitial.setOnClickListener { requestInterstitialBannerAd(AdType.BANNER) }
