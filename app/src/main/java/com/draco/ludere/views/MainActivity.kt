...
class MainActivity : AppCompatActivity() {
    ...
    val afile = assets.open( "example.nes" )
    val bfile = File(storagePath + "/example.nes")
    ...
    fun sendMsg(view: View) {
        ...
        openURL.data = Uri.parse("myket://comment?id=com.draco.ludere.superAdventureIsland")
    ...
    fun goToPage(view: View) {
        val openURL = Intent(android.content.Intent.ACTION_VIEW)
        openURL.data = Uri.parse("myket://details?id=com.draco.ludere.superAdventureIsland")
        startActivity(openURL)
    }
