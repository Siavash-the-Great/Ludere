...
class MainActivity : AppCompatActivity() {
    ...
    fun sendMsg(view: View) {
        ...
        openURL.data = Uri.parse("myket://comment?id=com.draco.ludere.CastleVaniaCircleOfTheMoon")
    ...
    fun goToPage(view: View) {
        val openURL = Intent(android.content.Intent.ACTION_VIEW)
        openURL.data = Uri.parse("myket://details?id=com.draco.ludere.CastleVaniaCircleOfTheMoon")
        startActivity(openURL)
    }
